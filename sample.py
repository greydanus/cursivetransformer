...
def generate_helper_fn(model, dataset, word_list, num_steps=1250, do_sample=False,
    ...
    SEED_TOKENS = [torch.tensor(
        [341,   0, 341,  11, 341,  11, 341,  11, 341,  11, 415,  14, 421,
        16, 418,  15, 415,  14, 415,  14, 414,  14, 341, 116, 314,  74,
       405,  12, 405,  12, 415,  14, 330,  13, 341,  11, 341,  15, 341,
       116, 296,  38, 405,  12, 405,  12, 409,  17, 405,  12, 409,  17,
       341, 116, 316,  75, 442,   8, 435,  14, 418,  15, 394,  12, 354,
        11, 369,   8, 389,  12, 405,  12, 435,  14, 450,   8, 254,  10,
       291,  12, 311,  13, 326,  14, 320,  17, 309,  15, 296,  12, 254,
        10, 341, 116, 454], dtype=torch.int64)][seed_ix]
