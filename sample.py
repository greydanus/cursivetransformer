...
def generate_helper_fn(model, dataset, word_list, num_steps=1250, do_sample=False,
    ...
    SEED_TOKENS = [torch.tensor(
        [571,   0, 557,  20, 544,  34, 547,  31, 541,  31, 533,  27, 669,
        24, 647,  29, 637,  25, 605,  24, 571,  25, 554,  26, 541,  31,
       537,  29, 554,  26, 571,  13, 680,  25, 650,  31, 637,  25, 610,
        22, 590,  23, 571,  25, 547,  31, 537,  29, 532,  27, 631,   8,
       631,  24, 631,  24, 590,  23, 571,  25, 571, 231, 510, 113, 680,
         5, 548,   7, 571,  13, 674,  22, 556,  20, 642,  14, 491,  16,
       595,  19, 680,   4, 571, 231, 623, 110, 554,  26, 544,  28, 533,
        27, 522,   8, 631,  24, 631,  24, 631,  24, 631,  24, 631,  24,
       631,  24, 631,  24, 649,  25, 467,  25, 516,  24, 522,  24, 527,
        25, 547,  31, 550,  28, 552,  38, 571, 231, 513, 106, 492,   6,
       571,   9, 631,  12, 491,  16, 606,  19, 504,  17, 608,  14, 485,
        19, 616,  21, 543,  22, 673,  18, 582,  13, 478,  18, 571, 231,
       619, 109, 530,  17, 544,  34, 537,  29, 532,  27, 631,  24, 625,
        24, 622,  16, 631,  24, 666,  20, 467,  25, 571,  13, 577,  25,
       571,  17, 547,  31, 541,  31, 541,  31, 554,  26, 596,  25, 490,
        22, 680,  17, 657,  31, 637,  25, 606,  19, 590,  23, 571,  25,
       547,  19, 544,  28, 540,  25, 547,  31, 625,  24, 631,  24, 637,
        25, 631,  16, 637,  25, 637,  25, 637,  25, 637,  25, 646,  10,
       528,  21, 527,  29, 527,  25, 522,  24, 527,  25, 528,  25, 532,
        27, 547,  19, 554,  26, 588,  17, 619,  24, 637,  25, 664,  26,
       680,  17, 680,  25, 571,  25, 577,  25, 571,  25, 566,  26, 541,
        31, 571, 231, 684], dtype=torch.int64)][seed_ix]
    SEED_CHARS = ['748'][seed_ix]
    ...
    def trunc_or_pad_words(word_list):
      ...
      if n > n_words:
        ...
        return word_list + ['TOLAPYPI', 'Hkggcvr!', '9074', '0.', 'efhgb.'][:max(0, n_words-n)]
      return word_list
