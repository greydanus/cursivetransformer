...
_**Fixing cross attention.** I found a critical bug in my cross-attention implementation. I had forgotten to add a positional embedding to the character-level token embedding. When I fixed this, sample quality improved spectacularly. It was surprising that the model was able to generate half-coherent sequences before this. Increasing learning rate by 10x made training a lot faster._
