...
def main():
    ...
    parser.add_argument('--quote_prob', type=float, default=0.05, help='Probability of adding a quote (single or double) to a word')
    parser.add_argument('--parenthesis_prob', type=float, default=0.05, help='Probability of adding a parenthesis (open or close) to a word')
    parser.add_argument('--sentence_flow_prob', type=float, default=0.175, help='Probability of adding sentence flow punctuation to a word')
